...
exports.handler = async function (context, event, callback) {
    ...
    const firstInteract = 'Hola, gracias por comunicarte con M&M Desarrollos, mi nombre es Mia. Puedo proporcionar información sobre apartamentos, casas o inversiones. ¿Cómo puedo ayudarte hoy?'
